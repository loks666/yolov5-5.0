...
# sock.connect((HOST, PORT)) # 因为只需要建立一次连接所以放检测函数得外面
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if len(det):
                ...
                for c in det[:, -1].unique():
                    ...
                    # if names[int(c)] == "straight":
                    #     sock.send(b'122')   # 以二进制传输
                    #     print("给树莓派发送过去了",names[int(c)])
                    # if names[int(c)] == "left":
                    #     sock.send(b'123')  # 以二进制传输
                    #     print("给树莓派发送过去了", names[int(c)])
                    # if names[int(c)] == "right":
                    #     sock.send(b'124')   # 以二进制传输
                    #     print("给树莓派发送过去了",names[int(c)])
                    # if names[int(c)] == "return":
                    #     sock.send(b'125')  # 以二进制传输
                    #     print("给树莓派发送过去了", names[int(c)])
